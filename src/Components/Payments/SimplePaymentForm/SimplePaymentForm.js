        ...
        <form className="Form payment-form" onSubmit={handleSubmit}>
            <fieldset className="FormGroup">
                <Field
                    ...
                    required
                    autoComplete="name"
                    value={billingDetails.name = loggedInUser.name}
                    onChange={(e) => {
                        setBillingDetails({ ...billingDetails, name: loggedInUser.name });
                    }}
                />
                <Field
                    label="Email"
                    ...
                    required
                    autoComplete="email"
                    value={billingDetails.email = loggedInUser.email}
                    onChange={(e) => {
                        setBillingDetails({ ...billingDetails, email: loggedInUser.email });
                    }}
                />
                <Field
                    label="Phone"
